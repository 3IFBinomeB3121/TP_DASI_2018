...
public class Service {
    ...
    public static void ajouterEmploye() throws ParseException {
        ...
        Employe emp = new Employe(true,0,24,"mme","karda","helene",d1,"20 Rue Decomberousse, Villeurbanne", "helene.karda@outlook.fr", "0630276677", "dasi_18");
        Employe emp2 = new Employe(true,0,24,"mme","eti","julie",d1,"61 Avenue Roger Salengro, Villeurbanne", "julie.eti@hotmail.fr", "0630276677", "pdp");
     ...
     * corrects, sinon renvoie null. Dans le cas ou un employé et un client
     * auraient exactement les mêmes mails et mdp, le premier dans la liste 
     * sera le client.
     */
     ...
     */
    public static List<Intervention> consulterOpeDuJour () {
        ...
        listInterv = InterventionDAO.rechercherInterventionParHorodate(today, tomorrow);
        
        JpaUTIL.fermerEntityManager();
        return listInterv;
    }
    
    public static List<Intervention> consulterInterventionEnCours(Employe emp){
        JpaUTIL.creerEntityManager();
        List<Intervention> interEnCours = null;
        if (emp.isDisponibilite() == false){
            interEnCours = InterventionDAO.rechercherInterventionEnCours(emp);
        }
        JpaUTIL.fermerEntityManager();
        return interEnCours;
    }
