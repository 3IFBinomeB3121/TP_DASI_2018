...
public class InterventionDAO {
     ...
     */
    public static List<Intervention> rechercherInterventionParHorodate(Calendar today, Calendar tomorrow) {
        List<Intervention> listIntervention; 
        EntityManager em = JpaUTIL.obtenirEntityManager();
        Query query = em.createQuery("SELECT i FROM Intervention i WHERE"
                + " i.horodate >=:aujourdhui AND i.horodate<=:demain"); 
    ...
    public static List<Intervention> rechercherInterventionEnCours(Employe emp){
        List<Intervention> listIntervention; 
        EntityManager em = JpaUTIL.obtenirEntityManager();
        Query query = em.createQuery("SELECT i FROM Intervention i WHERE"
                + " i.employe=:unEmploye"); 
        query.setParameter("unEmploye", emp);
        listIntervention = query.getResultList();
        return listIntervention;
    }
