...
public class GeoTest {
    ...
    public static void main(String[] args) {
        ...
        if (MA_CLE_GOOGLE_API.equals("AIzaSyAhf3JleYpal9S-xouJYH8lf7Dvz5Y2Nko")) {
            for (int i=0; i<100; i++) {
                System.err.println("[ERREUR] VOUS AVEZ OUBLIE DE CHANGER LA CLE DE L'API !!!!!");
            }
            System.exit(-1);
        }
        ...
        System.out.println("DurÃ©e de Trajet Ã  VÃ©lo de Adresse #1 Ã  Adresse #3 en passant par Adresse #2: " + duree + " min");

        Double distance = getTripDistanceByCarInKm(coords1, coords3);
        System.out.println("Distance en Voiture de Adresse #1 Ã  Adresse #3 (trajet direct par la route): " + distance + " km");

        Double distanceVolDOiseau = getFlightDistanceInKm(coords1, coords3);
        System.out.println("Distance Ã  Vol d'Oiseau de Adresse #1 Ã  Adresse #3 (distance gÃ©ographique): " + distanceVolDOiseau + " km");
    }
}
